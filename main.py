...
class BMI_Calc(MDApp):
    ...
    def callback_change_theme(self):
        self.colour_list = ['Blue', 'Pink', 'Yellow', 'Green', 'Orange', 'DeepPurple', 'LightBlue', 'Red', 'Indigo', 'LightGreen', 'DeepOrange', 'Cyan', 'Lime', 'Teal', 'Amber', 'BlueGray', 'Purple']
        self.theme_cls.primary_palette = self.colour_list[self.i]
        #print(self.colour_list[self.i])
